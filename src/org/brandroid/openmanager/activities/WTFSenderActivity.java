		...
		implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			List<OpenPath> arr = new ArrayList<OpenPath>();
			arr.add(crashFile);
			OpenFile myPath = OpenFile.getExternalMemoryDrive(true);
			new EventHandler(new FileManager()).cutFile(arr, myPath.getChild(crashFile.getName().substring(1)), this);
			crashFile = myPath.getChild(crashFile.getName().substring(1));
		}*/
		if(crashFile != null && crashFile.exists())
		{
