...
public class SimpleHostKeyRepo extends KnownHosts
{
	...
	public SimpleHostKeyRepo(JSch jsch, UserInfo userinfo, SharedPreferences prefs) throws JSchException
	{
		super(jsch);
		mPrefs = prefs;
		mUserInfo = userinfo;
		...
		{
			if(!(allPrefs.get(host) instanceof String)) continue;
	...
	public int check(String host, byte[] key) {
		...
		if(kcheck == OK) return OK;
		if(kcheck == CHANGED) return CHANGED;
