...
public interface MenuView {
    ...
    /**
     * Minimal interface for a menu item view.  {@link #initialize(MenuItemImplNew, int)} must be called
    ...
    public interface ItemView {
         ...
         */
        public void initialize(MenuItemImplNew itemData, int menuType);
        
        /**
         * Gets the item data that this view is displaying.
         * @return the item data, or null if there is not one
         */
        public MenuItemImplNew getItemData();
