...
public abstract class MediaSet extends MediaObject {
    ...
    public MediaSet(OpenPath path, long version) {
        super(path, version);
    }
    ...
    public int getIndexOfItem(OpenPath path, int hint) {
    ...
    protected int getIndexOf(OpenPath path, ArrayList<MediaItem> list) {
