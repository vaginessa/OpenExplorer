...
public class LocalAlbum extends MediaSet {
    ...
    private final OpenPath mItemPath;
    private int mCachedCount = INVALID_COUNT;

    public LocalAlbum(OpenPath path, OpenApp application, int bucketId,
    ...
    public ArrayList<MediaItem> getMediaItem(int start, int count) {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                OpenPath childPath = mItemPath.getChild(id);
    ...
    private static MediaItem loadOrUpdateItem(OpenPath path, Cursor cursor,
            DataManager dataManager, OpenApp app, boolean isImage) {
    ...
    public static MediaItem[] getMediaItemById(
            OpenApp application, boolean isImage, ArrayList<Integer> ids) {
        ...
        try {
            ...
            while (i < n && cursor.moveToNext()) {
                ...
                OpenPath childPath = itemPath.getChild(id);
