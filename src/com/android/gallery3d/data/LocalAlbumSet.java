...
public class LocalAlbumSet extends MediaSet {
    public static final OpenPath PATH_ALL = OpenPath.fromString("/local/all");
    public static final OpenPath PATH_IMAGE = OpenPath.fromString("/local/image");
    public static final OpenPath PATH_VIDEO = OpenPath.fromString("/local/video");
    ...
    private final OpenApp mApplication;
    ...
    public LocalAlbumSet(OpenPath path, OpenApp application) {
        ...
        mName = "Albums"; //application.getResources().getString(R.string.set_label_local_albums);
    }

    private static int getTypeFromPath(OpenPath path) {
    ...
    private MediaSet getLocalAlbum(
            DataManager manager, int type, OpenPath parent, int id, String name) {
        OpenPath path = parent.getChild(id);
