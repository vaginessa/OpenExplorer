...
public class LocalImage extends LocalMediaItem {
    ...
    static final OpenPath ITEM_PATH = OpenPath.fromString("/local/image/item");
    ...
    public LocalImage(OpenPath path, OpenApp application, Cursor cursor) {
        super(path, nextVersionNumber());
        mApplication = application;
        loadFromCursor(cursor);
    }

    public LocalImage(OpenPath path, OpenApp application, int id) {
        super(path, nextVersionNumber());
        mApplication = application;
    ...
    public static class LocalImageRequest extends ImageCacheRequest {
        ...
        LocalImageRequest(OpenApp application, OpenPath path, int type,
