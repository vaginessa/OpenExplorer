...
public class ClusterAlbum extends MediaSet implements ContentListener {
    ...
    private ArrayList<OpenPath> mPaths = new ArrayList<OpenPath>();
    private String mName = "";
    private DataManager mDataManager;
    private MediaSet mClusterAlbumSet;

    public ClusterAlbum(OpenPath path, DataManager dataManager,
    ...
    void setMediaItems(ArrayList<OpenPath> paths) {
        mPaths = paths;
    }

    ArrayList<OpenPath> getMediaItems() {
        return mPaths;
    }
    ...
    public static ArrayList<MediaItem> getMediaItemFromPath(
            ArrayList<OpenPath> paths, int start, int count,
            DataManager dataManager) {
        if (start >= paths.size()) {
            return new ArrayList<MediaItem>();
        }
        int end = Math.min(start + count, paths.size());
        ArrayList<OpenPath> subset = new ArrayList<OpenPath>(paths.subList(start, end));
