...
public class ComboAlbumSet extends MediaSet implements ContentListener {
    ...
    public ComboAlbumSet(OpenPath path, OpenApp application, MediaSet[] mediaSets) {
        super(path, nextVersionNumber());
        mSets = mediaSets;
        for (MediaSet set : mSets) {
            set.addContentListener(this);
        }
        mName = "All Albums"; //application.getResources().getString(R.string.set_label_all_albums);
    }
