...
public class FilterSet extends MediaSet implements ContentListener {
    ...
    private final ArrayList<OpenPath> mPaths = new ArrayList<OpenPath>();
    private final ArrayList<MediaSet> mAlbums = new ArrayList<MediaSet>();

    public FilterSet(OpenPath path, DataManager dataManager, MediaSet baseSet,
            int mediaType) {
