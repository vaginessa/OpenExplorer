...
public class ImageCacheService {
    ...
    public ImageData getImageData(OpenPath path, int type) {
    ...
    public void putImageData(OpenPath path, int type, byte[] value) {
        byte[] key = makeKey(path, type);
        long cacheKey = Utils.crc64Long(key);
    ...
    private static byte[] makeKey(OpenPath path, int type) {
