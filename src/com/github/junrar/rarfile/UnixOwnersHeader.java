...
extends SubBlockHeader 
{
	...
	public void print(){
		super.print();
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "ownerNameSize: "+ownerNameSize);
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "owner: "+owner);
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "groupNameSize: "+groupNameSize);
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "group: "+group);
	}
}
