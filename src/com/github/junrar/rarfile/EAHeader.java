...
extends SubBlockHeader 
{
	...
	{
		super.print();
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "unpSize: "+unpSize);
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "unpVersion: " + unpVer);
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "method: "+method);
		org.brandroid.utils.Logger.LogVerbose("RAR: " + "EACRC:" + EACRC);
	}
}
