...
public final class BoxConfig {
    ...
    private static final String API_URL_AUTHORITY = "app.box.com";
    ...
    private static final String DOWNLOAD_URL_AUTHORITY = "app.box.com";
    /** Default Download url path. */
    private static final String DOWNLOAD_URL_PATH = "/api/2.0/download/";
