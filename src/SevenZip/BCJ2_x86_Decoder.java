...
public class BCJ2_x86_Decoder implements ICompressCoder2 {
    ...
    SevenZip.BitDecoder _statusE8Decoder[] = new SevenZip.BitDecoder[256];
    SevenZip.BitDecoder _statusE9Decoder = new SevenZip.BitDecoder(kNumMoveBits);
    SevenZip.BitDecoder _statusJccDecoder = new SevenZip.BitDecoder(kNumMoveBits);
    
    OutWindow _outStream = new OutWindow();
    SevenZip.RangeCoderDecoder _rangeDecoder = new SevenZip.RangeCoderDecoder();
    ...
    int CodeReal(
        ...
        for (int i = 0; i < 256; i++) {
            _statusE8Decoder[i] = new SevenZip.BitDecoder(kNumMoveBits);
