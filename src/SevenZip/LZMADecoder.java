        ...
        
{
    class LenDecoder {
        ...
        public void Init() {
            SevenZip.RangeCoderDecoder.InitBitModels(m_Choice);
        ...
        public int Decode(SevenZip.RangeCoderDecoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        class Decoder2 {
            ...
            public void Init() {
                SevenZip.RangeCoderDecoder.InitBitModels(m_Decoders);
            }
            
            public byte DecodeNormal(SevenZip.RangeCoderDecoder rangeDecoder) throws IOException {
                int symbol = 1;
                do
            ...
            public byte DecodeWithMatchByte(SevenZip.RangeCoderDecoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do
                {
    ...
    SevenZip.RangeCoderDecoder m_RangeDecoder = new SevenZip.RangeCoderDecoder();
    ...
    void Init() throws IOException {
        ...
        SevenZip.RangeCoderDecoder.InitBitModels(m_IsMatchDecoders);
        SevenZip.RangeCoderDecoder.InitBitModels(m_IsRep0LongDecoders);
        SevenZip.RangeCoderDecoder.InitBitModels(m_IsRepDecoders);
        SevenZip.RangeCoderDecoder.InitBitModels(m_IsRepG0Decoders);
        SevenZip.RangeCoderDecoder.InitBitModels(m_IsRepG1Decoders);
        SevenZip.RangeCoderDecoder.InitBitModels(m_IsRepG2Decoders);
        SevenZip.RangeCoderDecoder.InitBitModels(m_PosDecoders);
