...
public class Handler implements SevenZip.IInArchive {
    ...
    public int Extract(int [] indices, int numItems,
      ...
      UInt32 fileIndex = ref.ItemIndex;
         ...
         */
                ...
                if (folderIndex == SevenZip.InArchive.kNumNoIndex) {
                    extractFolderInfoVector.add( new ExtractFolderInfo(
                            // #ifdef _7Z_VOL
                            // volumeIndex,
                            // #endif
                            fileIndex, SevenZip.InArchive.kNumNoIndex));
                    continue;
                }
         ...
         */
            ...
            #endif
             */
                            SevenZip.InArchive.kNumNoIndex, folderIndex));
        ...
        SevenZip_Decoder decoder = new SevenZip_Decoder(
                // #ifdef _ST_MODE
                false
                // #else
                // true
 ...
 */
    ...
    public SevenZipEntry getEntry(int index) {
        SevenZip.FileItem item = _database.Files.get(index);
        int index2 = index;
